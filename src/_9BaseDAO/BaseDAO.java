...
public abstract class BaseDAO {
    ...
    public <T> T getInstance(Connection connection, Class<T> tClass, String sql, Object... agrs) {
    ...
    public <T> List<T> getForQueryList(Connection connection, Class<T> tClass, String sql, Object... agrs) {
